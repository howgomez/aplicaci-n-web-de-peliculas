...
const AuthForm = () => {
  ...
  return (
   <div className='w-full h-screen text-white relative'>
     ...
     className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] lg:w-[20%] h-[60%] bg-gray-950/80 rounded-xl p-4 lg:p-14 border border-[#A458FF] flex flex-col gap-4 shadow-[0_0_10px_#A458FF]'>
     ...
     <div className='flex flex-col gap-4 mt-6'>
      ...
      />
      <button 
       className='w-full bg-[#A458FF] p-2 rounded-md hover:opacity-85 transition-all' 
       type='submit'>{isRegister ? 'Register' : 'Login'}
      </button>
